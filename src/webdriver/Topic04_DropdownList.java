...
public class Topic04_DropdownList {
	...
	@Test
	public void TC02_TextBoxTextArea() throws InterruptedException {
		// mngr142949 arYnemA
		String email1 = CommonFunction.RandomNumber();
		...
		String id = driver
				.findElement(By.xpath(".//table[@id='customer']//td[contains(.,'Customer ID')]/following-sibling::td"))
				.getText();
		...
		Assert.assertEquals(newCity,
				driver.findElement(By.xpath("//table[@id='customer']//td[contains(.,'City')]/following-sibling::td"))
						.getText());
		Assert.assertEquals(newAddress,
				driver.findElement(By.xpath("//table[@id='customer']//td[contains(.,'Address')]/following-sibling::td"))
						.getText());
